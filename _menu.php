            ...
            <nav class="absolute transparent">
                <div class="nav-bar">
                    <div class="module left">
                        <a href="index.html">
                            <img class="logo logo-light" alt="Foundry" src="http://mademill.com/img/mademill_text_light.png" />
                            <img class="logo logo-dark" alt="Foundry" src="http://mademill.com/img/logo-dark.png" />
                        </a>
                    </div>
				    ...
				    <li>
                                    <a href="http://mademill.com/3dscan/">
                                        3D Scan
                                    </a>
                                </li> 
